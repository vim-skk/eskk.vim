...
execute join(['function! vital#_eskk#Mapping#import() abort', printf("return map({'options_dict2chars': '', 'execute_unmap_command': '', 'get_map_command': '', 'options_chars2raw': '', 'get_all_modes_list': '', 'execute_map_command': '', 'get_unabbr_command': '', 'get_abbr_command': '', 'options_dict2raw': '', 'options_chars2dict': '', 'get_all_modes': '', 'is_mode_char': '', 'get_unmap_command': '', 'execute_abbr_command': ''}, \"vital#_eskk#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
