...
lnoremap <expr> <Plug>(eskk:mode:hira:convert/switch-to-kata) eskk#mode#hira#do_q_key()
noremap! <expr> <Plug>(eskk:mode:hira:convert/switch-to-kata) eskk#mode#hira#do_q_key()
