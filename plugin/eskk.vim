...
let g:eskk_version = str2nr(printf('%2d%02d%03d', 0, 2, 412))
...
nnoremap        <Plug>(eskk:alpha-t) :<C-u>call eskk#jump_one_char('t')<CR>
nnoremap        <Plug>(eskk:alpha-f) :<C-u>call eskk#jump_one_char('f')<CR>
